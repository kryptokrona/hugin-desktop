<script>
    ...
    import {files, groups, misc, notify, pushToTalk, rooms, user} from '$lib/stores/user.js'
    ...
    window.api.receive('wallet-started', async ([node, my_groups, block_list, my_contacts, deleteAfter, path, avatar, idle, notifications, banned, fileList, avatars, syncImages, ptt]) => {
