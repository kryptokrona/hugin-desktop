...
<div class="relative overflow-hidden pt-12">
  ...
  <div class="absolute top-0 w-full flex items-center border-y border-r border-neutral-800 h-12 px-4">
    <h3 class="text-lg">Recommended groups</h3>
  </div>

  <div class="w-full h-full overflow-scroll no-scrollbar border-r border-neutral-800">
