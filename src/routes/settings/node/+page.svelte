	...
	<section class="card">
		...
		<div class="info-grid">
			...
			<div class="info-item">
				...
				<span class="info-value">
					{truncateAddress($HuginNode.address)}
				</span>
			</div>
		</div>
		...
		<div class="controls-section">
			<div class="mode-toggle">
				<button class="toggle-btn {$HuginNode.public ? 'active' : ''}" onclick={() => ($HuginNode.public = true)}>
					{t('public') || 'Public'}
				</button>
				<button
					class="toggle-btn {!$HuginNode.public ? 'active' : ''}"
					onclick={() => ($HuginNode.public = false)}
				>
					{t('private') || 'Private'}
				</button>
			</div>
			...
			{#if !$HuginNode.public}
				<div class="input-wrapper" transition:slide|local={{ duration: 250 }}>
					<input
						...
						bind:value={$HuginNode.inputAddress}
						class="node-input"
					/>
				</div>
			{/if}
