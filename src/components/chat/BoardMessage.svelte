        ...
        <div>
            <div class="header">
                <div style="display: flex; align-items: center; margin-left: -10px">
                    ...
                    <h5 class="nickname">{nickname}<span class="time"
                                                         on:click={()=> dispatch('findMsg', {hash: hash, board: board})}>| <Time
                            relative timestamp="{parseInt(message.time * 1000)}"/> |
                        {#if $boards.thisBoard === "Home"}@{board}{/if}</span></h5>
                </div>
                <div class="actions">
