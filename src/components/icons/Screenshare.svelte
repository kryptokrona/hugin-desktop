    ...
    <g clip-path="url(#110100104481219910650104107)">
      <g transform="translate(428.0 188.0)">
        ...
        <g transform="translate(12.0 17.219970703125)">
          <path d="M0,0 L0,4.78000069" stroke="{color}" stroke-width="1.5" fill="none" stroke-linecap="round"
                stroke-linejoin="round" stroke-dasharray=" 0.0 0.0"></path>
        </g>
        <g transform="translate(2.0 13.0)">
          <path d="M0,0 L20,0" stroke="{color}" stroke-width="1.5" fill="none" stroke-linecap="round"
                stroke-linejoin="round" stroke-dasharray=" 0.0 0.0"></path>
        </g>
        <g transform="translate(7.5 22.0)">
          <path d="M0,0 L9,0" stroke="{color}" stroke-width="1.5" fill="none" stroke-linecap="round"
                stroke-linejoin="round" stroke-dasharray=" 0.0 0.0"></path>
        </g>
      </g>
    </g>
