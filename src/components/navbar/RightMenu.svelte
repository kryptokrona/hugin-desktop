<script>
    ...
    $: if (thisCall) {
        let active_video = $webRTC.call.find(
            (a) => a.chat === active_contact.chat
        )
    ...
    {#if $page.url.pathname === '/messages'}
        <div class="nav">
            <img
                ...
                alt=""
                on:click={() =>
                    copyThis($user.activeChat.chat + $user.activeChat.key)}
            />
        ...
        <div class="nav" style="height: 100%">
            <div class="nav">
                ...
                <button class="button">
                    <ListButton
                        on:click={() =>
                            ($layoutState.showActiveList =
                                !$layoutState.showActiveList)}
                    />
                </button>
            </div>
            <div class="draggable hitbox" />
            <div class="button">
