...
a=msid-semantic: WMS
m=audio ` + external_ports[0] + ` UDP/TLS/RTP/SAVPF 111 103 1105 13 110 112 113 126
...
m=video ` + external_ports[(external_ports.length / 3)] +  ` UDP/TLS/RTP/SAVPF 102 104 106 108 102
c=IN IP4 ` + external_ip + `
a=rtcp:9 IN IP4 0.0.0.0
` + candidates[2] +
        `a=ice-ufrag:` + ice_ufrag + `
...
a=group:BUNDLE 0 1 2
a=msid-semantic: WMS
m=audio ` + external_port + ` UDP/TLS/RTP/SAVPF 111 103 104 913 110 112 113 126
c=IN IP4 ` + external_ip + `
a=rtcp:9 IN IP4 0.0.0.0
` + candidates +
        `a=ice-ufrag:` + ice_ufrag + `
...
a=rtpmap:113 telephone-event/16000
a=rtpmap:126 telephone-event/8000
m=video 9 UDP/TLS/RTP/SAVPF 102 104 106 108 102
c=IN IP4 0.0.0.0
a=rtcp:9 IN IP4 0.0.0.0
a=ice-ufrag:` + ice_ufrag + `
a=ice-pwd:` + ice_pwd + `
